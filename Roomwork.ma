...
//Name: Roomwork.ma
//Last modified: Tue, Mar 13, 2018 12:47:11 PM
//Codeset: 1252
...
createNode transform -s -n "persp";
	...
	setAttr ".v" no;
	setAttr ".t" -type "double3" 16.65875510656614 5.3945924709848212 -11.967400026006201 ;
	setAttr ".r" -type "double3" -1.5383527293077057 125.7999999998476 0 ;
...
createNode camera -s -n "perspShape" -p "persp";
	...
	setAttr ".coi" 30.560278461538175;
...
createNode mesh -n "pCubeShape1" -p "pCube1";
	...
	setAttr ".vir" yes;
	setAttr ".vif" yes;
	setAttr ".pv" -type "double2" 0.38153755664825439 0.25546360015869141 ;
...
createNode lightLinker -s -n "lightLinker1";
	rename -uid "57842C71-4AA8-5142-06FA-E880B15F4799";
	setAttr -s 2 ".lnk";
	setAttr -s 2 ".slnk";
createNode shapeEditorManager -n "shapeEditorManager";
	rename -uid "6586E357-41A8-F443-DBE7-8BB77380FC8F";
createNode poseInterpolatorManager -n "poseInterpolatorManager";
	rename -uid "BCCD5E7D-452B-E57D-431E-3B8E5159148F";
createNode displayLayerManager -n "layerManager";
	rename -uid "DC1A21A4-4251-BED0-8476-FDB68526CD2D";
createNode displayLayer -n "defaultLayer";
	rename -uid "99970F20-4603-79AD-400D-7483C27DB6F1";
createNode renderLayerManager -n "renderLayerManager";
	rename -uid "3E24D4CE-4441-7983-1C1A-F0926AC33779";
...
createNode polyTweak -n "polyTweak3";
	...
	setAttr ".uopa" yes;
	setAttr -s 11 ".tk";
	setAttr ".tk[29]" -type "float3" 0 -1.6237774 0 ;
	setAttr ".tk[30]" -type "float3" 0 -1.6237774 0 ;
	setAttr ".tk[31]" -type "float3" 0 -1.6237774 0 ;
	setAttr ".tk[32]" -type "float3" 0 -1.6237774 0 ;
